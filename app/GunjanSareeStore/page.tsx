...
// ============================================
// CONFIGURATION - CHANGE THESE VALUES FOR DIFFERENT VENDORS
// ============================================

const STORE_CONFIG = {
  // Store Basic Information
  storeName: 'Gunjan Saree Store',
  storeInitial: 'G', // Single letter for logo
  tagline: 'Your Trusted Saree Destination in Purnia',
  ...
  // Address & Location
  address: 'Shop No. 12, Main Market Road, Purnia, Bihar 854301',
  city: 'Purnia',
  state: 'Bihar',
  pincode: '854301',
  country: 'IN',
  latitude: '25.7771',
  longitude: '87.4753',
  googleMapsUrl: 'https://maps.google.com/?q=Gunjan+Saree+Store+Purnia',
  
  // Business Hours
  openingHours: {
    display: 'Open 24 Hours • 7 Days a Week',
    is24Hours: true,
    schemaFormat: 'Mo-Su 00:00-24:00', // For Schema.org
  },
  ...
  // Hero Section
  hero: {
    badge: 'Premium Saree Collection',
    mainHeading: 'Discover Beautiful Sarees',
    subHeading: 'for Every Occasion',
    description: 'Experience the finest collection of traditional and contemporary sarees. From elegant silk to stunning Banarasi weaves, find your perfect drape at unbeatable prices.',
    mainImage: 'https://images.unsplash.com/photo-1610030469983-98e550d6193c?w=800&q=80',
    imageCaption: 'Wedding Special Collection',
    imageSubCaption: 'Exclusive designs for your special day',
  },
  ...
  offerBanner: {
    ...
    description: 'Flat 20% OFF on all Wedding Sarees • Limited Time Only',
  },
  ...
  features: [
    { 
      ...
      description: 'Handpicked fabrics & authentic materials' 
    },
    { 
      icon: 'Heart', 
      title: 'Affordable Pricing', 
      description: 'Best value for premium sarees' 
    },
    { 
      icon: 'Award', 
      title: 'Huge Variety', 
      description: '1000+ designs in stock' 
    },
    { 
      icon: 'Clock', 
      title: '24/7 Open', 
  ...
  reviews: [
    { 
      name: 'Priya Sharma', 
      rating: 5, 
      text: 'Beautiful collection! Found the perfect wedding saree. The quality is outstanding and staff is very helpful.' 
    },
    { 
      name: 'Anjali Singh', 
      rating: 5, 
      text: 'Best saree store in Purnia. Affordable prices and excellent variety. Highly recommend!' 
    },
    { 
      name: 'Meera Verma', 
      rating: 4, 
      text: 'Great collection of silk sarees. Loved shopping here. Will definitely visit again for festivals.' 
    },
    { 
      name: 'Kavita Kumari', 
      rating: 5, 
      text: 'Amazing experience! The 24-hour availability is so convenient. Found exactly what I was looking for.' 
    }
  ],
  ...
  sections: {
    collections: {
      ...
      subtitle: 'Handpicked sarees for every celebration and occasion'
    },
    whyChooseUs: {
      title: 'Why Choose Gunjan Saree Store?',
      subtitle: 'Your trusted destination for authentic, premium sarees'
    },
    reviews: {
      title: 'What Our Customers Say',
      subtitle: '4.2 Rating on Google • 87 Reviews'
    },
    visitStore: {
  ...
  whatsapp: {
    enabled: true,
    defaultMessage: "Hi, I'm interested in your saree collection"
  },
  
  // Schema.org type (ClothingStore, Store, LocalBusiness, etc.)
  schemaType: 'ClothingStore',
  
  // Business Description for SEO
  seoDescription: 'Premium saree store in Purnia offering wedding sarees, festive collections, daily wear, silk and Banarasi sarees. Open 24 hours.',
};
...
// ============================================
// MAIN COMPONENT - DO NOT MODIFY UI STRUCTURE
// ============================================
    ...
    <div className="min-h-screen bg-gradient-to-b from-amber-50 via-rose-50 to-amber-50">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "openingHours": config.openingHours.schemaFormat,
          ...
          <div className="flex items-center justify-between h-20">
            <div className="flex items-center space-x-3">
              <div className="w-12 h-12 bg-gradient-to-br from-rose-600 to-amber-600 rounded-full flex items-center justify-center shadow-xl">
                <span className="text-white font-bold text-xl">{config.storeInitial}</span>
              </div>
              <div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8 animate-fadeIn">
              <div className="inline-block">
                <div className="flex items-center space-x-2 bg-gradient-to-r from-rose-100 to-amber-100 border-2 border-rose-200 px-4 py-2 rounded-full">
                  ...
                  <span className="text-sm font-semibold text-rose-800">{config.hero.badge}</span>
                </div>
              </div>
              ...
              <h2 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight" style={{ fontFamily: 'Playfair Display, serif' }}>
                ...
                <br />
                <span className="text-gray-800">{config.hero.subHeading}</span>
              </h2>
              ...
              <div className="flex items-center space-x-2 text-amber-600">
                ...
                <span className="ml-2 text-gray-700 font-semibold">{config.rating} Rating • {config.totalReviews} Reviews</span>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                ...
                {config.whatsapp.enabled && (
                  <a
                    href={`https://wa.me/${config.whatsappNumber}?text=${encodeURIComponent(config.whatsapp.defaultMessage)}`}
                    target="_blank"
            ...
            <div className="relative">
              <div className="relative rounded-3xl overflow-hidden shadow-2xl transform hover:scale-105 transition-transform duration-500">
                <img
                  src={config.hero.mainImage}
                  alt={config.hero.imageCaption}
                ...
                <div className="absolute bottom-8 left-8 right-8 text-white">
                  ...
                  <p className="text-sm opacity-90">{config.hero.imageSubCaption}</p>
                </div>
              </div>
        ...
        <section className="py-8 px-4 bg-gradient-to-r from-rose-600 via-rose-500 to-amber-600 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto text-center relative z-10">
            <p className="text-white text-2xl md:text-3xl font-bold mb-2" style={{ fontFamily: 'Playfair Display, serif' }}>
              {config.offerBanner.title}
            </p>
            <p className="text-white/90 text-lg">
              {config.offerBanner.description}
            </p>
          </div>
        </section>
      )}
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-white to-amber-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h3 className="text-5xl font-bold mb-4 bg-gradient-to-r from-rose-700 to-amber-700 bg-clip-text text-transparent" style={{ fontFamily: 'Playfair Display, serif' }}>
              {config.sections.whyChooseUs.title}
            </h3>
            <p className="text-xl text-gray-600" style={{ fontFamily: 'Cormorant Garamond, serif' }}>
              {config.sections.whyChooseUs.subtitle}
            </p>
          </div>
...
return (
                ...
                >
                  <div className="w-16 h-16 bg-gradient-to-br from-rose-100 to-amber-100 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                    {IconComponent && <IconComponent className="w-8 h-8 text-rose-600" />}
                  </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600" style={{ fontFamily: 'Cormorant Garamond, serif' }}>
              {config.sections.reviews.subtitle}
            </p>
          </div>
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-amber-50 to-rose-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h3 className="text-5xl font-bold mb-4 bg-gradient-to-r from-rose-700 to-amber-700 bg-clip-text text-transparent" style={{ fontFamily: 'Playfair Display, serif' }}>
              {config.sections.visitStore.title}
            </h3>
            <p className="text-xl text-gray-600" style={{ fontFamily: 'Cormorant Garamond, serif' }}>
              {config.sections.visitStore.subtitle}
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <div className="inline-block bg-gradient-to-r from-emerald-100 to-green-100 border-2 border-emerald-400 px-4 py-2 rounded-full">
                      <span className="text-emerald-800 font-bold">{config.openingHours.display}</span>
                    </div>
                  </div>
                </div>
            ...
            <div className="rounded-2xl overflow-hidden shadow-xl h-[500px]">
              <iframe 
                allowFullScreen
                src={`https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3595.123456789!2d${config.longitude}!3d${config.latitude}!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjXCsDQ2JzM3LjYiTiA4N8KwMjgnMzEuMSJF!5e0!3m2!1sen!2sin!4v1234567890123!5m2!1sen!2sin`}
                width="100%"
                height="100%"
                style={{ border: 0 }}
                loading="lazy"
                referrerPolicy="no-referrer-when-downgrade"
                title={`${config.storeName} Location`}
              ></iframe>
            </div>
          </div>
        </div>
      ...
      <footer className="bg-gradient-to-b from-gray-900 to-gray-800 text-white py-12 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="flex items-center justify-center space-x-2 mb-6">
            ...
            <span className="ml-2 text-gray-300">{config.rating} Rating • {config.totalReviews} Reviews</span>
          </div>
          <p className="text-gray-400 mb-2">{config.address}</p>
          <p className="text-gray-400 mb-6">{config.phoneNumber}</p>
          <p className="text-gray-500 text-sm">
            © 2024 {config.storeName}. All rights reserved. {config.openingHours.display}
          </p>
        </div>
      </footer>
